...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      // Wunschrundflüge
      { source: '/rundfluege/wunschrundfluege/oesterreich_rundflug', destination: '/rundfluege/oesterreich', permanent: true },
      { source: '/rundfluege/wunschrundfluege/rundflug_schweiz', destination: '/rundfluege/schweiz', permanent: true },
      { source: '/rundfluege/wunschrundfluege', destination: '/rundfluege/wunschrundflug', permanent: true },
      // Flugzeug / Erlebnisse
